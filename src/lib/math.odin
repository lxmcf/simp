...
load_math_library :: proc(state: ^simp.State) {
    simp.bind_native_proc(state, "rand", fn_rand)
    simp.bind_native_proc(state, "abs", fn_abs)
    simp.bind_native_proc(state, "sqrt", fn_sqrt)
    simp.bind_native_proc(state, "sin", fn_sin)
    simp.bind_native_proc(state, "cos", fn_cos)
    simp.bind_native_proc(state, "pow", fn_pow)
    simp.bind_native_proc(state, "min", fn_min)
    simp.bind_native_proc(state, "max", fn_max)
    simp.bind_native_proc(state, "floor", fn_floor)
    simp.bind_native_proc(state, "ceil", fn_ceil)
    simp.bind_native_proc(state, "round", fn_round)
}
...
fn_abs :: proc(state: ^simp.State, arguments: []simp.Value) -> simp.Value {
    ...
    if parsed_float, is_valid := simp.value_as_f64(arguments[0]); is_valid {
...
fn_pow :: proc(state: ^simp.State, arguments: []simp.Value) -> simp.Value {
    ...
    base_value, is_base_valid := simp.pop_f64(&args)
    exponent_value, is_exponent_valid := simp.pop_f64(&args)
...
fn_min :: proc(state: ^simp.State, arguments: []simp.Value) -> simp.Value {
    ...
    left_value, is_left_valid := simp.pop_f64(&args)
    right_value, is_right_valid := simp.pop_f64(&args)
